              ...
              <MDBCol lg="8">
                <div className="p-5">
                  <div className="d-flex justify-content-between align-items-center mb-5">
                    <MDBTypography tag="h1" className="fw-bold mb-0 text-black"  style={{color:'#2F58CD'}}>
                      Shopping Cart
                    </MDBTypography>
                  ...
                  <div className="pt-5">
                    <MDBTypography tag="h6" className="mb-0 ">
                      <MDBCardText tag="a" href="/HomePage" className="text-body">
              ...
              <MDBCol lg="4" className="bg-grey">
                <div className="p-5">
                  ...
                  <div className="d-flex justify-content-between mb-4">
                    ...
                    <MDBTypography tag="h5">RS 900</MDBTypography>
                  </div>
                  ...
                  <MDBBtn className="dark" block size="lg" href="/Payment">
                    Next
                  </MDBBtn>
                </div>
              </MDBCol>
